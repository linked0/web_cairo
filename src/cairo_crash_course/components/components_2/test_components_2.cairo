use web_cairo::cairo_crash_course::components::components_2::mock_contract_components_2::ComponentsMockContract;
use web_cairo::cairo_crash_course::components::components_2::components_exercise_2::{
