...
pub fn add_felt(value: (felt252, felt252)) -> felt252 {
    let (x, y) = value;
    return x + y;
}

// TODO: Implement subtract_felt
pub fn subtract_felt(x: felt252, y: felt252) -> u8 {
...
pub fn multiply_felt(x: u32, y: felt252) -> u32 {
    return x * y.try_into().unwrap();
}

// TODO: Implement divide_felt
pub fn divide_felt(x: u64, y: u64) -> felt252 {
    return (x / y).try_into().unwrap();
}
