...
use cairo_course_exercises::cairo_crash_course::first_cairo_contract::first_cairo_contract_1::first_cairo_contract::IMyFirstCairoContractDispatcher;
use cairo_course_exercises::cairo_crash_course::first_cairo_contract::first_cairo_contract_1::first_cairo_contract::IMyFirstCairoContractDispatcherTrait;
