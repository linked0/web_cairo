...
// TODO: Write an interface for the mint() and burn() functions
#[starknet::interface]
...
mod MyToken {
    ...
    // TODO: Implement the mint() and burn() external functions according to the instructions   
    #[abi(embed_v0)]
    impl MyToken of super::IERC20MintingAndBurning<ContractState> {
        fn mint(ref self: ContractState, to: ContractAddress, amount: u256) {
            // Check that the caller is the owner
            assert(self._check_owner() == true, 'Only the owner can mint tokens');
    ...
    // TODO: Implement an internal function for checking that the caller is the owner
    #[generate_trait]
